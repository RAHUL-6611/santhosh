...
import { professors, associFacultyData, assisFacultyData, supportingStaff } from "./facultyProfilePage"
...
export default function Faculty() {
	...
	return (
		<>
			{
				(state.condition) ? <FacultyParts changeState={changeState} /> : <Individual name={state.name} image={state.image} changeState={changeState} />
			}
		</>
	);
}
...
function FacultyParts({ changeState }){
	return(
		<>
		    <FacultySingle Fname="Professors" changeState={changeState} data={professors} />
			<FacultySingle Fname="Associate professors" changeState={changeState} data={associFacultyData} />
			<FacultySingle Fname="Assistant professors" changeState={changeState} data={assisFacultyData} />
			<FacultySingle Fname="Supporting staff" changeState={changeState} data={supportingStaff} />
		</>
	)
}
				...
				<div className="big col-span-4">
					...
					<div className="big-in fac-info flex">
						...
						<div className="big-cont p-10">
							...
							<div onClick={()=>{ changeState(false, name, image) }} style={{"cursor" : "pointer"}}>view full profile</div>
						</div>
					</div>
				</div>
